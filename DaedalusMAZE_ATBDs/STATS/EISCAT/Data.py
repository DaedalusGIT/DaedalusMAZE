...
#def appendTo_AllValuesBuckets( kp_to_fall, alt_to_fall, lat_to_fall, mlt_to_fall, aValue ):
#    global AllValuesBuckets
#    AllValuesBuckets[ kp_to_fall, alt_to_fall, lat_to_fall, mlt_to_fall, "Vals" ].append( aValue )
